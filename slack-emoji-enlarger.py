...
parser.add_argument("-gc", "--gif_compression", type=int, help="amount of lossy gif compression to apply before uploading. default is 30 which is very light compression. 200 is heavy compression")
...
for row in range(num_rows):
    ...
    for col in range(num_cols):
        ...
        DEFAULT_GIF_COMPRESSION = 30
        GIF_COMPRESSION = args.gif_compression if args.gif_compression else DEFAULT_GIF_COMPRESSION
